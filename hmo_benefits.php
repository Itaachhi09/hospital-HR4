...
<head>
    ...
    <title>Avalon - HMO Benefits</title>
    ...
    <script>
        ...
        window.DESIGNATED_DEFAULT_SECTION = 'hmoBenefits';
    </script>
    <script src="js/main.js" type="module" defer></script>
    <script src="js/employee/hmo_benefits.js" type="module" defer></script>
    ...
    <div id="app-container" class="flex min-h-screen w-full">
            ...
            <div class="side-menu px-4 py-6 flex-grow overflow-y-auto">
                <ul class="space-y-2">
                    <li class="menu-option">
                        <a href="employee_landing.php" class="menu-name flex justify-between items-center space-x-3 hover:bg-[#F7E6CA] px-4 py-3 rounded-lg transition duration-300 ease-in-out cursor-pointer">
                    ...
                    <li class="menu-option">
                        <div class="menu-name flex justify-between items-center space-x-3 hover:bg-[#F7E6CA] px-4 py-3 rounded-lg transition duration-300 ease-in-out cursor-pointer" onclick="toggleDropdown('benefits-dropdown', this)">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm font-medium">Benefits & HMO</span>
                            </div>
                            <div class="arrow"><i class="bx bx-chevron-right text-lg font-semibold arrow-icon"></i></div>
                        </div>
                        <div id="benefits-dropdown" class="menu-drop hidden flex-col w-full bg-[#F7E6CA] rounded-lg p-3 space-y-1 mt-1">
                            <ul class="space-y-1">
                                <li><a href="#" id="hmo-benefits-link" class="block px-3 py-1 text-sm text-gray-800 hover:bg-white rounded hover:text-[#4E3B2A]">My HMO Benefits</a></li>
                                <li><a href="#" id="hmo-claims-link" class="block px-3 py-1 text-sm text-gray-800 hover:bg-white rounded hover:text-[#4E3B2A]">HMO Claims</a></li>
                                <li><a href="#" id="benefits-summary-link" class="block px-3 py-1 text-sm text-gray-800 hover:bg-white rounded hover:text-[#4E3B2A]">Benefits Summary</a></li>
                            </ul>
                        </div>
                    </li>
        ...
        <div class="main w-full md:ml-[320px] transition-all duration-300 ease-in-out flex flex-col min-h-screen">
            ...
            <main class="px-6 py-8 lg:px-8 flex-grow">
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold text-[#4E3B2A]" id="page-title">HMO Benefits</h2>
                    <p class="text-gray-600" id="page-subtitle">Manage your health insurance benefits and claims</p>
                </div>
                ...
                <div id="main-content-area">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6">
                            <h3 class="text-lg font-semibold text-[#4E3B2A] mb-4 font-header">My HMO Coverage</h3>
                            <div id="hmo-coverage-info" class="space-y-3">
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Provider:</span>
                                    <span id="hmo-provider" class="font-medium">Loading...</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Plan Type:</span>
                                    <span id="hmo-plan-type" class="font-medium">Loading...</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Coverage Amount:</span>
                                    <span id="hmo-coverage-amount" class="font-medium">Loading...</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Valid Until:</span>
                                    <span id="hmo-valid-until" class="font-medium">Loading...</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div class="space-y-3">
                                <button id="view-benefits-btn" class="w-full bg-[#594423] text-white py-2 px-4 rounded-md hover:bg-[#4E3B2A] transition duration-300">
                                    <i class="fa-solid fa-eye mr-2"></i>View Detailed Benefits
                                </button>
                                <button id="submit-claim-btn" class="w-full bg-[#594423] text-white py-2 px-4 rounded-md hover:bg-[#4E3B2A] transition duration-300">
                                    <i class="fa-solid fa-plus mr-2"></i>Submit New Claim
                                </button>
                                <button id="find-provider-btn" class="w-full bg-[#594423] text-white py-2 px-4 rounded-md hover:bg-[#4E3B2A] transition duration-300">
                                    <i class="fa-solid fa-search mr-2"></i>Find HMO Provider
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Recent Claims -->
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <h3 class="text-lg font-semibold text-[#4E3B2A] mb-4 font-header">Recent Claims</h3>
                        <div id="recent-claims" class="overflow-x-auto">
                            <table class="min-w-full table-auto">
                                ...
                                <tbody id="claims-table-body" class="bg-white divide-y divide-gray-200">
                                    <tr>
                                        <td colspan="6" class="px-4 py-4 text-center text-gray-500">Loading claims...</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
        ...
        <!-- HMO Benefits Modal -->
        <div id="hmo-benefits-modal" class="fixed inset-0 z-[60] hidden items-center justify-center p-4 modal" aria-labelledby="hmo-benefits-modal-title" role="dialog" aria-modal="true">
            <div id="hmo-benefits-modal-overlay" class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>
            <div class="modal-content bg-white rounded-lg shadow-xl transform transition-all sm:max-w-4xl w-full p-6 space-y-4 overflow-y-auto max-h-[90vh]">
                <div class="flex justify-between items-center pb-3 border-b">
                    <h3 class="text-lg font-medium text-[#4E3B2A] font-header" id="hmo-benefits-modal-title">HMO Benefits Details</h3>
                    <button type="button" id="close-hmo-benefits-modal-btn" class="text-gray-400 hover:text-gray-600">
                        <span class="sr-only">Close</span>
                        <i class="fa-solid fa-times text-xl"></i>
                    </button>
                </div>
                <div id="hmo-benefits-modal-content" class="space-y-4">
                    <p>Loading benefits details...</p>
                </div>
                <div class="pt-4 flex justify-end space-x-3 border-t mt-4">
                    <button type="button" id="close-hmo-benefits-modal-footer-btn" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">Close</button>
                </div>
            </div>
        </div>

        <!-- Submit Claim Modal -->
        <div id="submit-claim-modal" class="fixed inset-0 z-[60] hidden items-center justify-center p-4 modal" aria-labelledby="submit-claim-modal-title" role="dialog" aria-modal="true">
            <div id="submit-claim-modal-overlay" class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>
            <div class="modal-content bg-white rounded-lg shadow-xl transform transition-all sm:max-w-2xl w-full p-6 space-y-4">
                <div class="flex justify-between items-center pb-3 border-b">
                    <h3 class="text-lg font-medium text-[#4E3B2A] font-header" id="submit-claim-modal-title">Submit New HMO Claim</h3>
                    <button type="button" id="close-submit-claim-modal-btn" class="text-gray-400 hover:text-gray-600">
                        <span class="sr-only">Close</span>
                        <i class="fa-solid fa-times text-xl"></i>
                    </button>
                </div>
                <form id="submit-claim-form" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="claim-type" class="block text-sm font-medium text-gray-700 mb-1">Claim Type:</label>
                            <select id="claim-type" name="claim_type" required class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#4E3B2A] focus:border-[#4E3B2A]">
                        ...
                        <div>
                            <label for="claim-amount" class="block text-sm font-medium text-gray-700 mb-1">Claim Amount:</label>
                            <input type="number" id="claim-amount" name="claim_amount" step="0.01" min="0" required placeholder="0.00" class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#4E3B2A] focus:border-[#4E3B2A]">
                        </div>
                        <div class="md:col-span-2">
                            <label for="provider-name" class="block text-sm font-medium text-gray-700 mb-1">Healthcare Provider:</label>
                            <input type="text" id="provider-name" name="provider_name" required placeholder="Enter provider name" class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#4E3B2A] focus:border-[#4E3B2A]">
                        </div>
                        <div class="md:col-span-2">
                            <label for="treatment-date" class="block text-sm font-medium text-gray-700 mb-1">Treatment Date:</label>
                            <input type="date" id="treatment-date" name="treatment_date" required class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#4E3B2A] focus:border-[#4E3B2A]">
                        </div>
                        <div class="md:col-span-2">
                            <label for="claim-description" class="block text-sm font-medium text-gray-700 mb-1">Description:</label>
                            <textarea id="claim-description" name="claim_description" rows="3" required placeholder="Describe the treatment or service received" class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#4E3B2A] focus:border-[#4E3B2A]"></textarea>
                        </div>
                        <div class="md:col-span-2">
                            <label for="receipt-upload" class="block text-sm font-medium text-gray-700 mb-1">Receipt/Invoice (Optional):</label>
                            <input type="file" id="receipt-upload" name="receipt_upload" accept=".jpg,.jpeg,.png,.pdf" class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#4E3B2A] focus:border-[#4E3B2A]">
                        </div>
                    </div>
                    <div class="pt-2 flex justify-end space-x-3">
                        <button type="button" id="cancel-submit-claim-btn" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">Cancel</button>
                        <button type="submit" class="px-4 py-2 bg-[#594423] text-white rounded-md hover:bg-[#4E3B2A]">Submit Claim</button>
                    </div>
                    <div id="submit-claim-status" class="text-sm text-center h-4 mt-2"></div>
                </form>
            </div>
        </div>

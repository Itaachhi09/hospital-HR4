...
--
-- Table structure for table `hrcore_documents`
--

CREATE TABLE `hrcore_documents` (
...
--
-- Indexes for table `hrcore_documents`
--
ALTER TABLE `hrcore_documents`
  ADD PRIMARY KEY (`doc_id`),
  ADD KEY `idx_emp_id` (`emp_id`),
  ADD KEY `idx_module_origin` (`module_origin`),
  ADD KEY `idx_category` (`category`),
  ADD KEY `idx_status` (`status`),
  ADD KEY `idx_upload_date` (`upload_date`),
  ADD KEY `idx_emp_module` (`emp_id`,`module_origin`),
  ADD KEY `idx_category_status` (`category`,`status`);

--
-- Constraints for table `hrcore_documents`
--
ALTER TABLE `hrcore_documents`
  ADD CONSTRAINT `fk_hrcore_documents_employee` FOREIGN KEY (`emp_id`) REFERENCES `employees` (`EmployeeID`) ON DELETE CASCADE;

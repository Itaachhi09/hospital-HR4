<?php
/**
 * Delete Leave Type API - DISABLED FOR HR3 INTEGRATION
 * 
...
// Return placeholder response for deleting leave type
echo json_encode([
    'status' => 'integration_pending',
    'message' => 'Leave Management module is disabled for HR3 integration',
    'module' => 'leave_management',
    'endpoint' => 'DELETE /php/api/delete_leave_type.php',
...
/*
// Original delete leave type implementation has been disabled

...
try {
    ...
    // Success response with redirect handled by frontend (do not issue HTTP redirect)
    http_response_code(200);
    echo json_encode([
        'message' => 'Logout successful.',
        // Frontend runs from landing pages under hospital-HR4, so relative redirect is safe
